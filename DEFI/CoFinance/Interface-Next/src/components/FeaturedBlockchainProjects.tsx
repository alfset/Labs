        ...
        <div className="relative py-12">
            ...
            <div className="relative">
                <div className="text-center">
                    <p className="my-2 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl">Explore Our Service</p>
                </div>
                <div className="mt-10 mx-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
                        {featuredProjects.map((project: Project, index: number) => (
                            <div key={index} className="flex justify-center">
                                <div className="relative flex flex-col rounded-[22px] bg-transparent backdrop-filter backdrop-blur-lg overflow-hidden h-full max-w-sm p-1">
                                    <div className="absolute inset-0 border border-transparent animated-border"></div>
                                    <div className="relative p-4 sm:p-6 flex flex-col items-center text-center flex-grow bg-white dark:bg-zinc-900 rounded-[22px]">
                                        <Image
                                            src={project.image}
                                            alt={project.name}
                                            height={150}
