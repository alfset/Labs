...
contract Oracle is Initializable, OwnableUpgradeable {
    uint256 public  MIN_STAKE = 10 ether;
    uint256 public  MAX_MEMBERS = 100;
    uint256 public  PROPOSAL_FEE = 10 ether;
    uint256 public  REQUEST_FEE = 1 ether;
    uint256 public  PRICE_RETRIEVAL_FEE = 1 ether;

    mapping(address => uint256) public stakes;
    address[] public daoMembers;

    uint256 public totalProposalFeesCollected = 0;
    uint256 public totalRequestFeesCollected = 0;
